...
use backend\models\search\NationsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * NationsController implements the CRUD actions for Nations model.
 */
class NationsController extends Controller
{
    ...
    {
        if (($model = Nations::findOne($id)) !== null) {
            return $model;
        }
